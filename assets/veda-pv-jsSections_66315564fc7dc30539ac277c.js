function veda_fn_f6211a1fedcf4c44a0cf9c925d9a59b7 () {
      
  if (window.veda_fn_f6211a1fedcf4c44a0cf9c925d9a59b7Cleanup === undefined) {
    window.veda_fn_f6211a1fedcf4c44a0cf9c925d9a59b7Cleanup = {
      listeners: [],
      push(listener) {
  ...
  window.veda_fn_f6211a1fedcf4c44a0cf9c925d9a59b7Cleanup.cleanup();
...
veda_fn_f6211a1fedcf4c44a0cf9c925d9a59b7();
function veda_fn_9a7fb59e0b2346708190ef9008c9c368 () {
      
  if (window.veda_fn_9a7fb59e0b2346708190ef9008c9c368Cleanup === undefined) {
    window.veda_fn_9a7fb59e0b2346708190ef9008c9c368Cleanup = {
      listeners: [],
      push(listener) {
        this.listeners.push(listener);
      },
  ...
  window.veda_fn_9a7fb59e0b2346708190ef9008c9c368Cleanup.cleanup();
...
class PageProduct {
  ...
  handleUpdateJsPickUp(el) {
    ...
    btnPickUpCloseEls.forEach((btnPickUpCloseEl) => {
      ...
      window.veda_fn_9a7fb59e0b2346708190ef9008c9c368Cleanup.push(() => {
...
veda_fn_9a7fb59e0b2346708190ef9008c9c368();
function veda_fn_0d3e7b4cb45b46b29f8ef614cb0827a7 () {
      
  if (window.veda_fn_0d3e7b4cb45b46b29f8ef614cb0827a7Cleanup === undefined) {
    window.veda_fn_0d3e7b4cb45b46b29f8ef614cb0827a7Cleanup = {
      listeners: [],
      push(listener) {
        this.listeners.push(listener);
      },
  ...
  window.veda_fn_0d3e7b4cb45b46b29f8ef614cb0827a7Cleanup.cleanup();
...
window.veda_fn_0d3e7b4cb45b46b29f8ef614cb0827a7Cleanup.push(() => {
  instance.destroy();
});
...
veda_fn_0d3e7b4cb45b46b29f8ef614cb0827a7();
function veda_fn_b5b278e7b8e74cdf8122bba010774f5e () {
      
  if (window.veda_fn_b5b278e7b8e74cdf8122bba010774f5eCleanup === undefined) {
    window.veda_fn_b5b278e7b8e74cdf8122bba010774f5eCleanup = {
      listeners: [],
      push(listener) {
        this.listeners.push(listener);
      },
  ...
  window.veda_fn_b5b278e7b8e74cdf8122bba010774f5eCleanup.cleanup();
...
function handleCompare() {
  ...
  listCard.forEach((card) => {
    ...
    btnCompareEl.addEventListener("click", handleClick);
    window.veda_fn_b5b278e7b8e74cdf8122bba010774f5eCleanup.push(() => {
      btnCompareEl.removeEventListener("click", handleClick);
    });
  });
  let unsubscribeCompare = productCompare.subscribe((state) => {
...
veda_fn_b5b278e7b8e74cdf8122bba010774f5e();