function veda_fn_3dc6da625036463dac029f339690b274 () {
      
  if (window.veda_fn_3dc6da625036463dac029f339690b274Cleanup === undefined) {
    window.veda_fn_3dc6da625036463dac029f339690b274Cleanup = {
      listeners: [],
      push(listener) {
  ...
  window.veda_fn_3dc6da625036463dac029f339690b274Cleanup.cleanup();
...
veda_fn_3dc6da625036463dac029f339690b274();
function veda_fn_0134bfb61d6a4ffea95a931647d85f71 () {
      
  if (window.veda_fn_0134bfb61d6a4ffea95a931647d85f71Cleanup === undefined) {
    window.veda_fn_0134bfb61d6a4ffea95a931647d85f71Cleanup = {
      listeners: [],
      push(listener) {
        this.listeners.push(listener);
      },
  ...
  window.veda_fn_0134bfb61d6a4ffea95a931647d85f71Cleanup.cleanup();
...
class PageProduct {
  ...
  handleUpdateJsPickUp(el) {
    ...
    btnPickUpCloseEls.forEach((btnPickUpCloseEl) => {
      ...
      window.veda_fn_0134bfb61d6a4ffea95a931647d85f71Cleanup.push(() => {
...
veda_fn_0134bfb61d6a4ffea95a931647d85f71();
function veda_fn_3f246ba767d64bf4aa7d5786d22d3729 () {
      
  if (window.veda_fn_3f246ba767d64bf4aa7d5786d22d3729Cleanup === undefined) {
    window.veda_fn_3f246ba767d64bf4aa7d5786d22d3729Cleanup = {
      listeners: [],
      push(listener) {
        this.listeners.push(listener);
      },
  ...
  window.veda_fn_3f246ba767d64bf4aa7d5786d22d3729Cleanup.cleanup();
...
window.veda_fn_3f246ba767d64bf4aa7d5786d22d3729Cleanup.push(() => {
  instance.destroy();
});
...
veda_fn_3f246ba767d64bf4aa7d5786d22d3729();
function veda_fn_7e402a924b5f498c89dec191f3990a18 () {
      
  if (window.veda_fn_7e402a924b5f498c89dec191f3990a18Cleanup === undefined) {
    window.veda_fn_7e402a924b5f498c89dec191f3990a18Cleanup = {
      listeners: [],
      push(listener) {
        this.listeners.push(listener);
      },
  ...
  window.veda_fn_7e402a924b5f498c89dec191f3990a18Cleanup.cleanup();
...
function handleCompare() {
  ...
  listCard.forEach((card) => {
    ...
    btnCompareEl.addEventListener("click", handleClick);
    window.veda_fn_7e402a924b5f498c89dec191f3990a18Cleanup.push(() => {
      btnCompareEl.removeEventListener("click", handleClick);
    });
  });
  let unsubscribeCompare = productCompare.subscribe((state) => {
...
veda_fn_7e402a924b5f498c89dec191f3990a18();