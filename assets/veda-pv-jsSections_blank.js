function veda_fn_6b3cf04cc7c543328854b9f293094801 () {
      
  if (window.veda_fn_6b3cf04cc7c543328854b9f293094801Cleanup === undefined) {
    window.veda_fn_6b3cf04cc7c543328854b9f293094801Cleanup = {
      listeners: [],
      push(listener) {
  ...
  window.veda_fn_6b3cf04cc7c543328854b9f293094801Cleanup.cleanup();

      try {
        const uniqueId = "id_b70f79c8-30b4-4068-b215-ed328672bfa2";
...
veda_fn_6b3cf04cc7c543328854b9f293094801();
function veda_fn_94eeeef340b24cc9ae669c1b885af54c () {
      
  if (window.veda_fn_94eeeef340b24cc9ae669c1b885af54cCleanup === undefined) {
    window.veda_fn_94eeeef340b24cc9ae669c1b885af54cCleanup = {
      listeners: [],
      push(listener) {
        this.listeners.push(listener);
      },
  ...
  window.veda_fn_94eeeef340b24cc9ae669c1b885af54cCleanup.cleanup();

      try {
        const uniqueId = "id_7c8229c3-6d44-4d2e-9f97-79b10995e212";
        const containers = document.querySelectorAll(`[data-id="${uniqueId}"]`);
        containers.forEach(container => {
          if (!container) {
            return;
...
class PageProduct {
  constructor() {
    ...
    this.swipper = swiper(container.querySelector(".veda-product-media"));
    this.init();
  }
  ...
  handleUpdateJsPickUp(el) {
    ...
    btnPickUpCloseEls.forEach((btnPickUpCloseEl) => {
      ...
      window.veda_fn_94eeeef340b24cc9ae669c1b885af54cCleanup.push(() => {
  ...
  handleAddCart() {
    ...
    if (!builderMode) {
      const formCart = container.querySelector("#product-add-cart");
...
veda_fn_94eeeef340b24cc9ae669c1b885af54c();
function veda_fn_9edfeab199f2484aa76eca2edd91737d () {
      
  if (window.veda_fn_9edfeab199f2484aa76eca2edd91737dCleanup === undefined) {
    window.veda_fn_9edfeab199f2484aa76eca2edd91737dCleanup = {
      listeners: [],
      push(listener) {
        this.listeners.push(listener);
      },
  ...
  window.veda_fn_9edfeab199f2484aa76eca2edd91737dCleanup.cleanup();

      try {
        const uniqueId = "id_f55bc049-c7b2-4520-a0bb-178ea61e5b17";
        const containers = document.querySelectorAll(`[data-id="${uniqueId}"]`);
        containers.forEach(container => {
          if (!container) {
            return;
...
window.veda_fn_9edfeab199f2484aa76eca2edd91737dCleanup.push(() => {
  instance.destroy();
});
...
function handleActiveAddOn() {
  ...
  const hasReviewItem = container.querySelector(".veda-review_widget");
  if (!!ratingItem && !!reviewItem && !!hasReviewItem) {
...
veda_fn_9edfeab199f2484aa76eca2edd91737d();
function veda_fn_3d5666bb514c4ab184b7e6d1090c2eca () {
      
  if (window.veda_fn_3d5666bb514c4ab184b7e6d1090c2ecaCleanup === undefined) {
    window.veda_fn_3d5666bb514c4ab184b7e6d1090c2ecaCleanup = {
      listeners: [],
      push(listener) {
        this.listeners.push(listener);
      },
  ...
  window.veda_fn_3d5666bb514c4ab184b7e6d1090c2ecaCleanup.cleanup();

      try {
        const uniqueId = "id_b217f369-8068-4758-88c6-15f90c6fcb77";
        const containers = document.querySelectorAll(`[data-id="${uniqueId}"]`);
        containers.forEach(container => {
          if (!container) {
            return;
...
function handleCompare() {
  ...
  listCard.forEach((card) => {
    ...
    btnCompareEl.addEventListener("click", handleClick);
    window.veda_fn_3d5666bb514c4ab184b7e6d1090c2ecaCleanup.push(() => {
      btnCompareEl.removeEventListener("click", handleClick);
    });
  });
  let unsubscribeCompare = productCompare.subscribe((state) => {
...
veda_fn_3d5666bb514c4ab184b7e6d1090c2eca();